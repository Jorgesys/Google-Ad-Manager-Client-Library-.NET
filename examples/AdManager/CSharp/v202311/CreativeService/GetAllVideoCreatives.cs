...
namespace Google.Api.Ads.AdManager.Examples.CSharp.v202311
{
    ...
    /// </summary>
    public class GetAllVideoCreatives : SampleBase
    {
        /// <summary>
        ...
        {
            get { return "Gets all VideoCreatives from \"Google Ad Manager\". | NetworkCode: 142849901"; }
        }
        ...
        {
            GetAllVideoCreatives codeExample = new GetAllVideoCreatives();
            ...
            using (CreativeService creativeService = user.GetService<CreativeService>())
            {
                ...
                do
                {
                    ...
                    if (page.results != null)
                    {
                        ...
                        {
                            Console.WriteLine("{0}) Creative with ID {1} and name \"{2}\" was found.", i++,
